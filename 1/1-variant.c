...
#define DEVICES_IN_FIRST_SYSTEM 6
#define DEVICES_IN_SECOND_SYSTEM 5
...
int main()
{
    int pi[] = {5, 8, 4, 8, 7, 6, 9, 12, 9, 15, 4, 8, 10, 8, 11};
    int pi1 = min(DEVICES_IN_FIRST_SYSTEM, pi[0], pi[1], pi[2], pi[3], pi[4], pi[5]);
    int pi2 = min(DEVICES_IN_SECOND_SYSTEM, pi[6], pi[7], pi[8], pi[9], pi[10]);
    int pi3 = min(DEVICES_IN_THIRD_SYSTEM, pi[11], pi[12], pi[13], pi[14]);
